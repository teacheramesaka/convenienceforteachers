...
## 概要  
Q：OKグーグル、三行でまとめて  
A：小テストの実施がクソ楽になるシステム（？）を作ったからみんな使ってみて♡  
### 前説  
...
・また、今回作成したものは、[こちらの記事](https://gasgas.itokeisuke.jp/gas/177/)を読みながら勉強し、その後、[ChatGPT先生](https://chat.openai.com/auth/login)にほとんど作ってもらいました。厚くお礼申し上げます
